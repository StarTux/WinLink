...
public abstract class BukkitRunnable implements Runnable {
     ...
     */
    public synchronized int runTask(Plugin plugin) throws IllegalArgumentException, IllegalStateException {
        checkState();
        //return setupId(Bukkit.getScheduler().runTask(plugin, this));
        return taskId = Bukkit.getScheduler().scheduleSyncDelayedTask(plugin, this);
    }
     ...
     */
    public synchronized int runTaskAsynchronously(Plugin plugin) throws IllegalArgumentException, IllegalStateException  {
        checkState();
        //return setupId(Bukkit.getScheduler().runTaskAsynchronously(plugin, this));
        return taskId = Bukkit.getScheduler().scheduleAsyncDelayedTask(plugin, this);
    }
     ...
     */
    public synchronized int runTaskLater(Plugin plugin, long delay) throws IllegalArgumentException, IllegalStateException  {
        checkState();
        //return setupId(Bukkit.getScheduler().runTaskLater(plugin, this, delay));
        return taskId = Bukkit.getScheduler().scheduleSyncDelayedTask(plugin, this, delay);
    }
     ...
     */
    public synchronized int runTaskLaterAsynchronously(Plugin plugin, long delay) throws IllegalArgumentException, IllegalStateException  {
        checkState();
        //return setupId(Bukkit.getScheduler().runTaskLaterAsynchronously(plugin, this, delay));
        return taskId = Bukkit.getScheduler().scheduleAsyncDelayedTask(plugin, this, delay);
    }
     ...
     */
    public synchronized int runTaskTimer(Plugin plugin, long delay, long period) throws IllegalArgumentException, IllegalStateException  {
        checkState();
        //return setupId(Bukkit.getScheduler().runTaskTimer(plugin, this, delay, period));
        return taskId = Bukkit.getScheduler().scheduleSyncRepeatingTask(plugin, this, delay, period);
    }
     ...
     */
    public synchronized int runTaskTimerAsynchronously(Plugin plugin, long delay, long period) throws IllegalArgumentException, IllegalStateException  {
        checkState();
        //return setupId(Bukkit.getScheduler().runTaskTimerAsynchronously(plugin, this, delay, period));
        return taskId = Bukkit.getScheduler().scheduleAsyncRepeatingTask(plugin, this, delay, period);
    }
